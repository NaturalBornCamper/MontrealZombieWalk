...
class MY_Lang extends CI_Lang {
    ...
    ***************************************************/
    ...
    function MY_Lang()
    {
		...
		if ( isset($_SERVER['HTTP_ACCEPT_LANGUAGE']) && preg_match('/^fr.*/i', $_SERVER['HTTP_ACCEPT_LANGUAGE']) )
...
//            header("Location: " . $CFG->site_url($this->localized($this->default_uri)), TRUE, 302);
            header("Location: " . $RTR->config->item('base_url').$this->localized($segment), TRUE, 302);
            exit;
        }
    }
