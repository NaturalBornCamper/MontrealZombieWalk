...
error_log('smart', 1, 'marco@naturalborncamper.com');
//Default settings
$settings = array(
	'baseDir' => '../',
	'charSet' => 'utf-8',
...
error_log(print_r($settings, true), 1, 'marco@naturalborncamper.com');
	$files = explode($settings['separator'], $fileNames);
	$settings['concatenate'] = count($files) > 1;
error_log(print_r($fileNames, true), 1, 'marco@naturalborncamper.com');
error_log(print_r($settings['concatenate'], true), 1, 'marco@naturalborncamper.com');
